package com.the.ultimate.tournament.games.config;
...
//    public static final String mainurl = "https://www.battleworld.in/battleworld/";
    ...
    public static final String howtojoin = "https://theultimate-tournaments.co.in";
    public static final String privacypolicy = "https://theultimate-tournaments.co.in";
    public static final String paytmchecksum = mainurl + "paytm/";

    public static final String youtubechannel = "https://www.youtube.com";
