...
public class ManualFragment extends Fragment {
    ...
    private static final String url = config.mainurl + "addmoney.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootViewone = inflater.inflate(R.layout.fragment_manual_payment, container, false);
...
//        }
        ...
        errorMessage.setText("Minimum Add Money amount is ₹ 20.");
        errorMessage.setTextColor(Color.parseColor("#ff0000"));
        errorMessage.setVisibility(View.VISIBLE);
        return false;
    }
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(context,"Add Money Request done succsessfully. please Wait...",Toast.LENGTH_LONG).show();
